      ...
      <div className="col-lg-4  col-md-6 col-sm-6">
        <div className="single-footer-widget">
          ...
          <div id="mc_embed_signup">
            <form target="_blank" 
            // noValidate="true" 
            action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&id=92a4423d01" method="get" className="form-inline">
      ...
      <div className="col-lg-3  col-md-6 col-sm-6">
        <div className="single-footer-widget mail-chimp">
          ...
          <ul className="instafeed d-flex flex-wrap">
            <li><img src="img/i1.jpg" /></li>
            <li><img src="img/i2.jpg" /></li>
            <li><img src="img/i3.jpg" /></li>
            <li><img src="img/i4.jpg" /></li>
            <li><img src="img/i5.jpg" /></li>
            <li><img src="img/i6.jpg" /></li>
            <li><img src="img/i7.jpg" /></li>
            <li><img src="img/i8.jpg" /></li>
          </ul>
        </div>
      </div>
