...
module.exports = {
  async up(queryInterface) {
    ...
    try {
      ...
      await queryInterface.bulkInsert("Tags", tags, { transaction: t });
      ...
      await queryInterface.bulkInsert("Reviews", reviews, { transaction: t });
      ...
      await resetAllSeqs(queryInterface.sequelize, t);
  ...
  async down(queryInterface) {
    ...
    try {
      ...
      await queryInterface.bulkDelete("Payments", null, { transaction: t });
      ...
      await queryInterface.bulkDelete("ProductTags", null, { transaction: t });
      await queryInterface.bulkDelete("Images", null, { transaction: t });
      await queryInterface.bulkDelete("Products", null, { transaction: t });
      await queryInterface.bulkDelete("Tags", null, { transaction: t });
